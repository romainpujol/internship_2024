...
\begin{algorithm}\caption{Improved algorithm for $C_l$}[h]
    \label{improved ls}
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Different approximation ratio for $n\in\{100,250\}$ and $m$ variable}
    \label{improvement ratio }
\end{figure}

\subsection{Local search, best-fit method, comparison of starters}

\subsection{Local search, first-fit method, comparison of starters}
\clearpage
